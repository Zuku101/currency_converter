...
if (isset($_POST['convert'])) {
    if (empty($amount) || $amount <= 0) {
        ...
        $result = $converter->convert($amount, $_SESSION['selectedFrom'], $_SESSION['selectedTo']);
        $stmt = $pdo->prepare("INSERT INTO conversions (from_currency, to_currency, amount, converted_amount, conversion_rate) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$_SESSION['selectedFrom'], $_SESSION['selectedTo'], $amount, $result, $result / $amount]);
